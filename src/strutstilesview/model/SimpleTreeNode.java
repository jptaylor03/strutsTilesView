...
public class SimpleTreeNode {
	...
	private List<SimpleTreeNode> children   = null; // Only used if userObject == null, else userObject is interrogated for children 
	...
	public SimpleTreeNode(String label, SimpleTreeNode parent) {
		this.setLabel(label);
		this.setParent(parent);
	}
	public SimpleTreeNode(String label, SimpleTreeNode parent, Object userObject) {
		this(label, parent);
		this.setUserObject(userObject);
	}
	public SimpleTreeNode(String label, SimpleTreeNode parent, Object userObject, String category) {
		this(label, parent, userObject);
		this.setCategory(category);
	}
	public SimpleTreeNode(String label, SimpleTreeNode parent, Object userObject, String category, String linkTarget) {
		this(label, parent, userObject, category);
		this.setLinkTarget(linkTarget);
	}
	public SimpleTreeNode(String label, SimpleTreeNode parent, Object userObject, String category, String linkTarget, Object info) {
...
//	}
	 ...
	 */
	public SimpleTreeNode getChildAt(int index) {
		SimpleTreeNode result = null;
		if        (userObject instanceof List) {
			List work = (List)userObject;
			result = (SimpleTreeNode)work.get(index);
		} else if (userObject instanceof Map) {
			Map work = (Map)userObject;
			result = (SimpleTreeNode)new ArrayList(work.values()).get(index);
		} else if (userObject instanceof Set) {
			Set work = (Set)userObject;
			result = (SimpleTreeNode)new ArrayList(work).get(index);
		} else if (userObject instanceof Object[]) {
			Object[] work = (Object[])userObject;
			result = (SimpleTreeNode)work[index];
		} else {
			if (children != null) {
				result = (SimpleTreeNode)children.get(index);
			}
		}
		return result;
	}
	 ...
	 */
	public int getIndex(TreeItem child) {
		int result = -1;
		if        (userObject instanceof List) {
			List work = (List)userObject;
	 ...
	 */
	public void add(SimpleTreeNode child) {
	 ...
	 */
	public void add(SimpleTreeNode child, Object emptyCheck) {
	 ...
	 */
	public void insert(SimpleTreeNode child, int index) {
	 ...
	 * @see #isEmpty(Object)
	 */
	public void insert(SimpleTreeNode child, int index, Object emptyCheck) {
